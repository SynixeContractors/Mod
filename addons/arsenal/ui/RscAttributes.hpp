...
class ace_arsenal_display {
    class controls {
        ...
        class restrictedGearBox: RscControlsGroupNoScrollbars {
            idc = IDC_restrictedGearBox;
            fade = 0;
            x = QUOTE(safeZoneX + safeZoneW - (94 + 48) * GRID_W);
            y = QUOTE(safeZoneY + 1.8 * GRID_H);
            w = QUOTE(47 * GRID_W);
            ...
            class controls {
                ...
                class restrictedGearText: RscText {
                    idc = IDC_restrictedGearText;
                    type = CT_STRUCTURED_TEXT;
                    style = ST_LEFT;
                    fade = 0;
                    x = QUOTE(0 * GRID_W);
        ...
        class restrictedGearTitle: RscText {
            idc = IDC_restrictedGearTitle;
            style = ST_CENTER;
            x = QUOTE(safeZoneX + safeZoneW - (94 + 47) * GRID_W);
            y = QUOTE(safeZoneY + 1.8 * GRID_H);
            w = QUOTE(47 * GRID_W);
            ...
            shadow=2;
            sizeEx = QUOTE(5 * GRID_H);
            text = "Restricted Gear Equipped";
        };
        class contrabandBox: RscControlsGroupNoScrollbars {
            idc = IDC_contrabandBox;
            fade = 0;
            x = QUOTE(safeZoneX + safeZoneW - (94 + 48) * GRID_W);
            y = QUOTE(safeZoneY + 1.8 * GRID_H);
            w = QUOTE(47 * GRID_W);
            ...
            class controls {
                ...
                class contrabandText: RscText {
                    idc = IDC_contrabandText;
                    type = CT_STRUCTURED_TEXT;
                    style = ST_LEFT;
                    fade = 0;
                    x = QUOTE(0 * GRID_W);
        ...
        class contrabandTitle: RscText {
            idc = IDC_contrabandTitle;
            style = ST_CENTER;
            x = QUOTE(safeZoneX + safeZoneW - (94 + 47) * GRID_W);
            y = QUOTE(safeZoneY + 1.8 * GRID_H);
            w = QUOTE(47 * GRID_W);
            h = QUOTE(5 * GRID_H);
            colorBackground[]={0,0,0,0};
            colorText[] = {0.75, 0.5, 1, 1};
            shadow=2;
            sizeEx = QUOTE(5 * GRID_H);
            text = "Contraband Equipped";
        };
    };
};
